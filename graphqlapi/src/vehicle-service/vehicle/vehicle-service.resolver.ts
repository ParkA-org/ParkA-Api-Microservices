...
import { VehicleColorService } from '../color/vehicle-color.service';
...
import { VehicleColorType } from '../color/vehicle-color-type/vehicle-color.type';
import { GetVehicleColorByIdInput } from '../color/vehicle-color-inputs/get-vehicle-color-by-id.input';
